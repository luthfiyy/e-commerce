...
<html lang="en">
    <head>
        ...
        {{-- @guest
            <p>Maaf anda harus login terlebih dahulu <a href="{{ route('login') }}">Login</a></p>
        @else --}}
    <body class="sb-nav-fixed">

        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">Hereels</a>
            <!-- Sidebar Toggle-->
        ...
        <script src="{{ asset('asset/admin') }}/assets/demo/chart-area-demo.js"></script>
        <script src="{{ asset('asset/admin') }}/assets/demo/chart-bar-demo.js"></script>
