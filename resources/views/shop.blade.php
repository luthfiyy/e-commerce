                                        ...
                                        <div class="card-body">
                                            <div class="shop__sidebar__categories">
                                                <ul class="nice-scroll">
                                                    <li><a href="#">Block Heels</a></li>
                                                    <li><a href="#">Cuban Heels</a></li>
                                                    <li><a href="#">Flare Heels</a></li>
                                                    <li><a href="#">High Heels</a></li>
                                                    <li><a href="#">Cone Heels</a></li>
                                                    <li><a href="#">Heeled Heels</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            <div class="shop__sidebar__brand">
                                                <ul>
                                                    ...
                                                    <li><a href="#">PORTE & PAIRE</a></li>
                                                    <li><a href="#">Dolce Vita</a></li>
                                                    <li><a href="#">CAMILLA ELPHICK</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
